function results = SpikeDetector(D,checkDetectionFlag,epochNo,refFlag,specialFlag)
...
%     - refFlag, 1, eleminate spikes that have refractory violations; 0, do
%     nothing
...
for i=1:Ntraces
    ...
    if ref_violations>0
        ...
        if refFlag ==1
            sp{i}(violation_ind{i}) = []; % delete those violations zy
        end
    end
